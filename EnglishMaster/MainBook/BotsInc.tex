...
%=================================================================
%:Preface
\input{00-Introduction/Introduction.tex}
\mainmatter
...
\pagestyle{headings}
%:Quick Tour
\input{01-Installation/Installation.tex}

%:First Application
\input{02-FirstScript/FirstScript.tex}

%:Turtle
\input{03-Turtle/Turtle.tex}

%:Turning
\input{04-Turning/Turning.tex}

%:Environment
\input{05-Environment/Environment.tex}

%:Fun With Robots
\input{06-FunWithRobots/FunWithRobots.tex}

%=================================================================
%:PART 2 -- Elementary Programming Concepts
\part{Elementary Programming Concepts}

\input{07-Looping/Looping.tex}

\input{08-Variables/Variables.tex}

\input{09-DeeperVariables/DeeperVariables.tex}

\input{10-LoopsAndVariables/10-LoopsAndVariables.tex}

\input{11-ComposingMessages/ComposingMessages.tex}

%=================================================================
%:PART 3 -- Bringing Abstraction into Play 
\part{Bringing Abstraction into Play}

\input{12-Methods/Methods.tex}
\input{13-CombiningMethods/CombiningMethods.tex}
% \input{14-ParametersAndArguments/ParametersAndArguments.tex}
...
% \input{19-ConditionalLoops/ConditionalLoops.tex}
